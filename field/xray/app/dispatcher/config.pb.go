...
var file_config_proto_goTypes = []any{
	(*SessionConfig)(nil), // 0: qingsu.core.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: qingsu.core.app.dispatcher.Config
}
var file_config_proto_depIdxs = []int32{
	0, // 0: qingsu.core.app.dispatcher.Config.settings:type_name -> qingsu.core.app.dispatcher.SessionConfig
